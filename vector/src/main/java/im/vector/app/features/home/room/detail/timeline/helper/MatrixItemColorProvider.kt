...
class MatrixItemColorProvider @Inject constructor(
    ...
    companion object {
        ...
        private fun getUserColorByIndex(index: Int): Int {
            return when (index % 8) {
                1 -> R.color.c_element_name_02
                2 -> R.color.c_element_name_03
                3 -> R.color.c_element_name_04
                4 -> R.color.c_element_name_05
                5 -> R.color.c_element_name_06
                6 -> R.color.c_element_name_07
                7 -> R.color.c_element_name_08
                else -> R.color.c_element_name_01
            }
        }
        ...
        private fun getColorFromRoomId(roomId: String?): Int {
            return when ((roomId?.toList()?.sumOf { it.code } ?: 0) % 3) {
                1 -> R.color.c_element_room_02
                2 -> R.color.c_element_room_03
                else -> R.color.c_element_room_01
            }
        }
    }
}
